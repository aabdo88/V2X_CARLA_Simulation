...
class Sim_settings:
    def __init__(self):
        ...
        self.sumo_gui = False
        self.client_order = 0
        self.tls_manager = 'None' #choices=['none', 'sumo', 'carla'],
...
class cv_simulation:
    def __init__(self):
        ...
        self.Pygame_resolution = [720, 610]
        self.Sumo_resolution = [520, 410]
        self.DSRC_range = 50
        self.rsu_range = 40
        self.screen = pygame.display.set_mode(self.Pygame_resolution)
    ...
    def tick(self):
        ...
        for veh in vehicle_id_list:
            ...
            draw_vehicle.create(veh, angle, pos, self.Pygame_resolution, self.Sumo_resolution, self.DSRC_range)
            draw_vehicle.draw(self.screen)
            cv = Connect_Vehicle()
            cv.read_and_send_parameters(veh, draw_vehicle, 0, Encrypt_status)
            cvs.append(cv)
        pygame.display.update()
        if Encrypt_status:
            self.communications_service.V2V(cvs)
# ==================================================================================================
...
def synchronization_loop(args):
    ...
    """
    connected_vehicles = cv_simulation()
...
if __name__ == '__main__':
    ...
    arguments = Sim_settings()

    arguments.sumo_cfg_file = 'examples/Town01.sumocfg'
    arguments.step_length = 0.1
    arguments.sumo_gui = True
    arguments.client_order = 1
    arguments.tls_manager = 'sumo'
    arguments.sync_vehicle_all = False
    arguments.sync_vehicle_lights = False
    arguments.sync_vehicle_color = False
    arguments.carla_host = '127.0.0.1'
    arguments.carla_port = 2000

    carla_simulation_location = 'C:/Users/ahmed/OneDrive/Desktop/CARLA_0.9.10/WindowsNoEditor'
    os.startfile(carla_simulation_location + '/CarlaUE4.exe')
    time.sleep(3)           # Sleep for 3 seconds
    carla_map = 'Town01'
    python2_command = 'C:/Users/ahmed/anaconda3/python.exe config.py --map ' + carla_map + ' --weather ClearSunset'
