...
class OBU:
    ...
    def sign_message(self, hex_WO_spaces):
        # 1609.2 epoch in seconds
        epoch1609Dot2 = 1072915200
        ## BSM1_1
        bsm1_1 = str(hex_WO_spaces)
        ...
        pca_cert = self.pca_cert
        pseudo_cert_7A_0 = self.pseudo_cert_7A_0
        pca_pub_x = self.pca_pub_x
        ...
        prv_recon_7A_0 = self.prv_recon_7A_0
        cert_seed_prv = self.cert_seed_prv
        cert_exp_val = self.cert_exp_val
        ...
        return signedbsm, pseudo_cert_7A_0, pca_cert, pca_pub


    def verify_signed_messages(self, message, pseudo_cert, pca_cert, pca_pub):
